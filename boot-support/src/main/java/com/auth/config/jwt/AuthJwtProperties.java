...
/**
 * JWT생성 및 검증에 필요한 설정 정보를 관리합니다.
 *
 */
// * <p>application.yml이나 application.properties에 적힌 텍스트 정보를 자바 객체로 옮겨 담는 역할을 합니다.</p>
@ConfigurationProperties(prefix = "auth.jwt")
public class AuthJwtProperties {

	/**
	 * JWT 서명에 사용할 비밀키입니다.
	 * <p>보안을 위해 HS256 알고리즘 기준 최소 32바이트 이상의 문자열을 권장합니다.</p>
	 */
