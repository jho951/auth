...
class OAuth2AuthenticationSuccessHandlerTest {
	...
	void onAuthenticationSuccess_ReturnsJwtResponse() throws Exception {
		...
		authProperties.setRefreshCookieEnabled(true);
		...
		RefreshCookieWriter refreshCookieWriter = new RefreshCookieWriter(authProperties, jwtProperties.getRefreshSeconds());
	...
	private OAuth2PrincipalResolver fakePrincipalResolver() {
		return identity -> new Principal("internal-user-1", List.of("USER"));
	}
